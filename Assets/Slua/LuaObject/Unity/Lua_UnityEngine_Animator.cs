...
public class Lua_UnityEngine_Animator : LuaObject {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_keepAnimatorStateOnDisable(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			UnityEngine.Animator self=(UnityEngine.Animator)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.keepAnimatorStateOnDisable);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_keepAnimatorStateOnDisable(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			bool v;
			checkType(l,2,out v);
			self.keepAnimatorStateOnDisable=v;
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_writeDefaultValuesOnDisable(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			UnityEngine.Animator self=(UnityEngine.Animator)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.writeDefaultValuesOnDisable);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_writeDefaultValuesOnDisable(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			bool v;
			checkType(l,2,out v);
			self.writeDefaultValuesOnDisable=v;
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,"keepAnimatorStateOnDisable",get_keepAnimatorStateOnDisable,set_keepAnimatorStateOnDisable,true);
		addMember(l,"writeDefaultValuesOnDisable",get_writeDefaultValuesOnDisable,set_writeDefaultValuesOnDisable,true);
